...
#[derive(FromForm)]
pub struct WavUpload<'r> {
    #[field(validate = ext(ContentType::WAV))]
    file: TempFile<'r>,
}

#[post("/wav", data = "<data>")]
pub async fn upload_wav(mut data: Form<WavUpload<'_>>) -> (Status, String) {
    let id = Id::new(8, "wav");
